...
static void call_show_coverage(pTHX) {
    dSP;
    PUSHMARK(SP);
    call_pv("Devel::Cover::show_coverage", G_VOID|G_DISCARD|G_EVAL);
    SPAGAIN;
}
...
static void dc_opfreehook(pTHX_ OP *o) {
    ...
    NDEB(D(L, "deleting op %p (%s)\n", o, OP_NAME(o)));
    {
        ...
        /* call_pv("Devel::Cover::collect_op", G_VOID|G_DISCARD|G_EVAL); */
        call_pv("Devel::Cover::collect_op", G_VOID|G_DISCARD);
