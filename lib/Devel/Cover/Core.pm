...
sub remove_contained_paths ($container, @paths) {
  ...
  my $regex = qr[ $ignore_case ^ \Q$container\E ($|/) ]x;
...
Devel::Cover::Core - Core utility subroutines for Devel::Cover
...
This module provides core utility subroutines that are loaded during
Devel::Cover's bootstrap phase.  All functions are importable on request via
L<Exporter>.

=head1 SUBROUTINES

=head2 remove_contained_paths ($container, @paths)
