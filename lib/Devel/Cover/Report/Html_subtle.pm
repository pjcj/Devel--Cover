...
# The heredoc is single-quoted for the template markup, so fill in the
# version by hand
$Templates{html} =~ s/\$VERSION/$Devel::Cover::Report::Html_subtle::VERSION
  . $Devel::Cover::Inc::Dev/e;
