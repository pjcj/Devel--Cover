...
Needed if you want to run cpancover.  That command is not installed - it sets
up a coverage service such as L<http://cpancover.com> and is run from a
checkout of the Devel::Cover repository.
...
You use special comments in your code to specify uncoverable criteria.
